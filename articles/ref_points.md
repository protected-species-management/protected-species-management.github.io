...
om_object <- om_object %>%
    update_pars(list(o = distribution(value = 1, name = "age at observation"), v = distribution(value = 4,
        name = "age at selectivity"), K = distribution(value = 1, name = "carrying capacity")))
...
# diagnostics(om_object0) objectives(om_object0)
```
...
# diagnostics(om_object1) objectives(om_object1)
```
